...
//Aluno *realocar_memoria_aluno(Aluno *alunos, int novo_tamanho);
//A função Aluno *realocar_memoria_aluno(Aluno *alunos, int novo_tamanho) tem como objetivo ajustar dinamicamente o tamanho do array de estruturas Aluno. Ela utiliza alocação dinamica de memoria para expandir o taamnho do array conforme necessario.
